...
const done = ref(props._assignment.done)
</script>

<template>
    <div class="tw-w-full tw-flex tw-flex-row tw-min-h-10">
        <v-checkbox class="-tw-mt-3 tw-w-10 tw-h-10" :color="_color" v-model="done" hide-details></v-checkbox>
        <div class="tw-w-32 tw-flex tw-flex-col tw-content-center tw-justify-center tw-text-gray-700 tw-leading-4">
            <span :class="{strike: done}">{{ _assignment.title }}</span>
