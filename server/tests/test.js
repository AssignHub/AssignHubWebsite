...
const { setSyllabusStatus } = require('../drive_uploader')
const { SyllabusStatus } = require('../constants')
...
//   // console.log(log)
//   await setSyllabusStatus('631943668d65b15fe693861d', SyllabusStatus.UPLOADED)
// })
